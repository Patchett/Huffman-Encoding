...
public:
    ...
    /**
     * Writes 8 bits from the passed in unsigned char to BitOutputStream's buf
     * @method writeByteBuffer
     * @param  b               holds the 8 bits that will be written to buf
     */
    void writeByteBuffer(unsigned char b);
